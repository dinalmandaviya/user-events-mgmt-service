...
const registerDetails = (body) => {    
    return new Promise(async (resolve, reject) => {
        try {            
            ...
            if (_.size(emailExist) !== 0) return reject(errorGanerator(comCon.CODE_SERVER_OK, comCon.MSG_EMAIL_ALREADY_EXISTS))
            ...
            const savedUser = await saveData(user, dbCon.COLLECTION_USER)
