...
const login = (body) => {
    return new Promise(async (resolve, reject) => {
        try {            
            ...
            const user = await getData({ email: body.email }, {"_id":false}, dbCon.COLLECTION_USER)
            ...
            const insertJSon = {}
            insertJSon[comCon.FIELD_USER_CODE] = user[0].userId
            ...
            finalResponse[comCon.FIELD_USER_CODE] = user[0].userId
